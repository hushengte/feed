...
public final class PatternCaptureGroupTokenFilter extends TokenFilter {
	 ...
	 * @param preserveOriginal set to true to return the original token even if one of the patterns matches
	...
	// correct offset, maybe used in highlighter
	private void correctOffset(int start, int end) {
		int startOffset = offsetAttr.startOffset();
		offsetAttr.setOffset(startOffset + start, startOffset + end);
	}
